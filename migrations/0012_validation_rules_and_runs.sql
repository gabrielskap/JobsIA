...
INSERT INTO "JobsIA_validation_rules" (secao, codigo, campo_alvo, ambiente, tipo_regra, severidade, mensagem, expressao)
VALUES
  ...
  ('5.1.2', 'RULE-WIN-PREFIX', 'file_name', 'Windows', 'regex', 'BLOQUEANTE', 
   ...
   '^[BDFJLPTWX]_[A-Z]{3}_[A-Z]{3}_[0-9]{3}'),
  ...
  ('5.2', 'RULE-DB-SQL-FORMAT', 'file_name', 'Global', 'regex', 'BLOQUEANTE',
   ...
   '^(pkg|pkgbody|pr|fc|tr)_[A-Za-z0-9_]{1,30}\.sql$'),
