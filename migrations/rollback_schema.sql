...
DROP TABLE IF EXISTS "JobsIA_application_validation_rules" CASCADE;
DROP TABLE IF EXISTS "JobsIA_job_checklist_requirements" CASCADE;
DROP TABLE IF EXISTS "JobsIA_checklist_catalog_items" CASCADE;
